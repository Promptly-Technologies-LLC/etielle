...
- **Performing arbitrary transformations**: Use the provided functions
  ...
  current item or its parent), or define your own custom ones.
...
- **Emitting to arbitrary formats**: Emit data to Pydantic models,
  TypedDicts, or ORM objects directly instead of plain dicts, with
  validation and type safety.
- **Optionally loading data into a database**: Load data into a database
  using SQLAlchemy or SQLModel with performant one-shot flushing.
