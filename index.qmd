...
1. **Start here**: Follow the Quick Start example below to see basic mapping
2. **Understand the pieces**: Read Core Concepts to learn about Context, Transforms, and TraversalSpec
3. **Go deeper**: Explore the detailed examples for nesting and merging
4. **Advanced features**: Check out the docs/ folder for instance emission, relationships, and more
