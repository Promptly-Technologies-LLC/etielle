# Custom Transforms: The <span class="citation" cites="transform">@transform</span> Decorator
...
The `@transform` decorator converts a function into a reusable transform factory. The function receives a [Context](../reference/Context.md#etielle.Context) object as its first parameter, and any additional parameters become factory arguments.
...
The [Context](../reference/Context.md#etielle.Context) object provides access to:
...
- [node()](../reference/node.md#etielle.node) - Returns `ctx.node`
...
- [Transforms](transforms.md) - Built-in transforms reference
- [Mapping Tables](mapping.md) - Using transforms in fields
