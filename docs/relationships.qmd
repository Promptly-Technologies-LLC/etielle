...
result = (
    ...
    .map_to(table=User, fields=[
        Field("id", get("id")),
        Field("name", get("name")),
        TempField("id", get("id"))  # Parent key
    ])
    ...
    .map_to(table=Post, fields=[
        ...
        Field("title", get("title")),
        TempField("id", get("id")),
        TempField("user_id", get_from_parent("id"))  # Foreign key
    ])
...
result = (
    ...
    .map_to(table=Item, fields=[
        ...
        TempField("id", get("id")),
        TempField("order_id", get_from_parent("id"))  # From parent order
    ])
...
|-----------|------|-------------|
| `parent` | `type` | The parent model class |
...
# Also valid: If you need user_id in output AND for linking
